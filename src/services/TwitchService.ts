const x = {
  "53831525": {
    profile_image_url:
      "https://static-cdn.jtvnw.net/jtv_user_pictures/740e0920-d065-4922-8900-b0510309d729-profile_image-300x300.png",
    cookbook_ids: ["fox"],
  },
  "116810429": {
    profile_image_url:
      "https://static-cdn.jtvnw.net/jtv_user_pictures/282fdf7b-4922-4759-855f-210c2b9021c7-profile_image-300x300.png",
    cookbook_ids: ["fox"],
  },
  "80615421": {
    profile_image_url:
      "https://static-cdn.jtvnw.net/jtv_user_pictures/n0ne-profile_image-f91f360d0a2f32ca-300x300.jpeg",
    cookbook_ids: ["falcon"],
  },
  "26551727": {
    profile_image_url:
  ...
  async getStreams(): Promise<any> {
    ...
    try {
      ...
      live = data.data.map((result) => {
        ...
        if (
          !this.streams[user_id].cookbook_ids.some(
            (el) => el === process.env.REACT_APP_COOKBOOK_ID
          )
        )
          return null;
        return {
